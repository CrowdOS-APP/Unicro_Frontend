...
public final class FragmentChangePasswdBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentChangePasswdBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView background3, @NonNull TextView blank1, @NonNull TextView email,
      @NonNull ImageView imageView3, @NonNull TextView password, @NonNull TextView password2,
      @NonNull TextView password3, @NonNull TextView signature3, @NonNull TextView signatureBlank3,
      @NonNull TextView userBack2, @NonNull TextView userName3, @NonNull TextView userName4) {
  ...
  @NonNull
  public static FragmentChangePasswdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentChangePasswdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_change_passwd, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentChangePasswdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChangePasswdBinding((ConstraintLayout) rootView, background3, blank1,
          email, imageView3, password, password2, password3, signature3, signatureBlank3, userBack2,
          userName3, userName4);
    }
