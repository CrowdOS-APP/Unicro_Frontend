...
public final class FragmentYourEventBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentYourEventBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView background3, @NonNull TextView blank1, @NonNull ImageView imageView3,
      @NonNull TextView signature3, @NonNull TextView signatureBlank3, @NonNull TextView userBack2,
      @NonNull TextView userName3, @NonNull TextView userName4) {
  ...
  @NonNull
  public static FragmentYourEventBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentYourEventBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_your_event, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentYourEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentYourEventBinding((ConstraintLayout) rootView, background3, blank1,
