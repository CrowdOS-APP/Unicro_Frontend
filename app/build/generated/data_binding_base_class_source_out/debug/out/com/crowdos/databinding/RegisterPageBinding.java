...
public final class RegisterPageBinding implements ViewBinding {
  ...
  private RegisterPageBinding(@NonNull ConstraintLayout rootView, @NonNull Button button9,
      @NonNull ImageView imageView12, @NonNull ImageView imageView15,
      @NonNull ImageView imageView16, @NonNull ImageView imageView2, @NonNull ImageView imageView7,
  ...
  public static RegisterPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RegisterPageBinding((ConstraintLayout) rootView, button9, imageView12, imageView15,
          imageView16, imageView2, imageView7, textView, textView12, textView13, textView14);
    }
