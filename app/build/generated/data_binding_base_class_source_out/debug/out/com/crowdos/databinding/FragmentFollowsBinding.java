...
public final class FragmentFollowsBinding implements ViewBinding {
  ...
  private FragmentFollowsBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView background3,
  ...
  @NonNull
  public static FragmentFollowsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFollowsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_follows, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFollowsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFollowsBinding((ConstraintLayout) rootView, background3, blank1,
