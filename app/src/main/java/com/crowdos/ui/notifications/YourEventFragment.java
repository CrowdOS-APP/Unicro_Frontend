...
import com.crowdos.databinding.FragmentYourEventBinding;


public class YourEventFragment extends Fragment {

    private FragmentYourEventBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentYourEventBinding.inflate(inflater, container, false);
        View view = binding.getRoot();
        if(view == null)
        {
            view = inflater.inflate(R.layout.fragment_your_event,container,false);
        }
